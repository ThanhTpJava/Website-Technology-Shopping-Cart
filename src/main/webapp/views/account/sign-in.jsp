			...
			<div class="card border-0 shadow rounded-3 my-5">
				<div class="card-body p-4 p-sm-5 bg-info-subtle">
					<form name="frmUser" class="was-validated m-auto " action="/PS22219_Thanhtp_ASM2/account/sign-in"
						...
						<div class="mb-3 text-center">
							<a class="text-decoration-none" href="/PS22219_Thanhtp_ASM2/account/forgot-password">Quên mật khẩu?</a>
						</div>
						<div class="mb-3 text-center ">
							<a class="text-decoration-none" href="/PS22219_Thanhtp_ASM2/account/sign-up">Đăng ký</a>
						</div>
